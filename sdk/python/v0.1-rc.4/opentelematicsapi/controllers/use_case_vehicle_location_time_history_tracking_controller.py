...
class UseCaseVehicleLocationTimeHistoryTrackingController(BaseController):

    """A Controller to access Endpoints in the opentelematicsapi API."""

    def __init__(self, client=None, call_back=None):
        super(UseCaseVehicleLocationTimeHistoryTrackingController, self).__init__(client, call_back)
    ...
    def get_fleet_location_history(self,
                                   ...
                                   page=None,
                                   count=None):
        """Does a GET request to /v1.0/fleet/locations/.
        ...
        **DENY**      | **DENY**   | **DENY**   | ALLOW      |
        ...
        """
        try:
            self.logger.info('get_fleet_location_history called.')
    
            # Prepare query URL
            self.logger.info('Preparing query URL for get_fleet_location_history.')
            _url_path = '/v1.0/fleet/locations/'
            ...
            # Prepare headers
            self.logger.info('Preparing headers for get_fleet_location_history.')
            _headers = {
                'accept': 'application/json'
            }
    
            # Prepare and execute request
            self.logger.info('Preparing and executing request for get_fleet_location_history.')
            _request = self.http_client.get(_query_url, headers=_headers)
            BasicAuth.apply(_request)
            _context = self.execute_request(_request, name = 'get_fleet_location_history')

            # Endpoint and global error handling using HTTP status codes.
            self.logger.info('Validating response for get_fleet_location_history.')
            if _context.response.status_code == 400:
                raise APIException('Error: startTime, stopTime, page or count parameters invalid', _context)
