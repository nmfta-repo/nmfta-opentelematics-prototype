...
class UseCaseVehicleLocationTimeHistoryTrackingControllerTests(ControllerTestBase):

    @classmethod
    def setUpClass(cls):
        super(UseCaseVehicleLocationTimeHistoryTrackingControllerTests, cls).setUpClass()
        cls.controller = cls.api_client.use_case_vehicle_location_time_history_tracking
    ...
    def test_get_fleet_location_history_1(self):
        ...
        result = self.controller.get_fleet_location_history(start_time, stop_time, page, count)
