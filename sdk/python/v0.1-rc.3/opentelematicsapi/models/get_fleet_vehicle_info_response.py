...
class GetFleetVehicleInfoResponse(object):

    """Implementation of the 'Get Fleet Vehicle Info response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the GetFleetVehicleInfoResponse class"""
