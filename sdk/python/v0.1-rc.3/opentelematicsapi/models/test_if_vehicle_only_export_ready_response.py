...
class TestIfVehicleOnlyExportReadyResponse(object):

    """Implementation of the 'Test if Vehicle-Only Export Ready response' model.
    ...
    def __init__(self,
                 location=None):
        """Constructor for the TestIfVehicleOnlyExportReadyResponse class"""
